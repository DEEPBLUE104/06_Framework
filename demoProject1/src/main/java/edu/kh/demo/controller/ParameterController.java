...
public class ParameterController {
	...
	public String paramTest2(@RequestParam("title") String title,
							 ...
							 @RequestParam("price") int price, // 형변환이 필요한 경우에는 파라미터 value값이 필수 작성되어있어야 함
	...
	public String paramTest3(@RequestParam("color") String[] colorArr,
		...
		// -> 같은 name속성을 가진 파라미터는 String[], List로 저장 x
		//	  첫 번째로 제출된 value값이 저장됨
		
		log.debug("paramMap:" + paramMap);
		//paramMap:{color=Red, fruit=Apple, productName=검볼, expirationDate=2025-05-10}
		return "redirect:/param/main";
	...
	public String paramTest4(/* @ModelAttribute */ MemberDTO inputMember) {
		...
		//redirect:/param/main 
		//(현재 위치가 중요!
		// -> 현재경로의 가장 마지막 부분을 redirect: 이주소로 변경하기때문) 
