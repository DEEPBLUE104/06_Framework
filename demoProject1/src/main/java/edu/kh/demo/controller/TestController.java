...
public class TestController {
	...
	// 1) 메서드에 작성 :
	// - 요청 주소와 해당 메서드를 매핑
	// - GET/POST 가리지 않고 매핑 (속성을 통해서 지정 가능 or 다른 어노테이션 이동)
	
//	@RequestMapping(value="/test", method = RequestMethod.GET)
	@RequestMapping("/test")	// test 요청 시 testMethod가 매핑하여 처리함
	public String testMethod() {
		System.out.print("/test 요청 받음");
	...
	/*
	 ...
	 public class TestController {
	 	...
	 	@RequestMapping("/insert") public String 메서드명() {}
	  
	  	@RequestMapping("/select") public String 메서드명() {}
	  
	  	@RequestMapping("/update") public String 메서드명() {}
